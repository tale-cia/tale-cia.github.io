...
// $('#record-footer-content .footer-block__col:nth-child(2) .footer-block__descr').text(' ');
// $('#record-main-logo .logos').appendTo('#record-footer-content .footer-block__col:nth-child(2) .footer-block__descr');
// $('#record-furnitura-logo .logos').appendTo('#record-footer-content .footer-block__col:nth-child(2) .footer-block__descr');
// $('#record-apvikna-logo .logos-ap').appendTo('#record-footer-content .footer-block__col:nth-child(2) .footer-block__descr');
