        ...
        caret: function(begin, end) {
            ...
            if (typeof begin == 'number') {
                ...
                return this.each(function() {
                    if (this.setSelectionRange) { this.setSelectionRange(begin, end) } else {
            ...
            return this.trigger("unmask").each(function() {
                ...
                function keydownEvent(e) {
                    ...
                    if (k === 8 || k === 46 || (iPhone && k === 127)) {
                        ...
                        if (k === 13) { blurEvent.call(this, e) } else {
                            if (k === 27) {
                                input.val(focusText);
...
(function($) {
    window.tildaBrowserLang = (!sessionStorage.getItem('lang')) ? "UK" : sessionStorage.getItem('lang'); //window.navigator.userLanguage || window.navigator.language;
    window.tildaBrowserLang = window.tildaBrowserLang.toUpperCase();
    if (window.tildaBrowserLang.indexOf('UK') != -1) { window.tildaBrowserLang = 'UK' } else { window.tildaBrowserLang = 'RU' } // фandтв 'EN'
    ...
    window.tildaForm = {
        ...
        arMessages: {
            ...
            'UK': {
                'success': 'Дякуємо! Дані успішно відправлені.',
                'successorder': 'Дякуємо! Заказ прийнятий. Будь ласка, зачекайте. Проводиться перехід до оплати....'
            }
        },
        arValidateErrors: {
            'EN': {
            ...
            'UK': {
                ...
                'string': 'Ви написали некоректні символи. Дозволені лише літери, числа та знаки пунктуації',
                'req': 'Будь ласка, заповніть усі обов’язкові поля',
                'minlength': 'Занадто коротке значення',
                'maxlength': 'Занадто довге',
                'reqfield': 'Обов’язкове поле',
                'emptyfill': 'Ні одне поле не заповнене'
            }
        }
    };
    $(document).ready(function() {
        ...
        window.tildaForm.hideErrors = function($jform) {
            ...
            if ($popupError.length > 0) { $popupError.fadeOut() }
        };
        ...
        window.tildaForm.cloudpaymentPay = function($jform, arArgs) {
            ...
            window.cloudpaymentshandler.charge({ publicId: arArgs.publicId, description: arArgs.description, amount: parseFloat(arArgs.amount), currency: currency, accountId: arArgs.accountId, invoiceId: arArgs.invoiceId, requireEmail: arArgs.requireEmail == !0 ? !0 : !1, email: arArgs.email, skin: arArgs.skin, data: arData }, function(options) {
                ...
                $jform.data('successmessage', '');
                window.cloudpaymentshandler = !1;
                if (arArgs.failureurl > '') { window.location.href = arArgs.failureurl } else {
                    ...
                    success: function(json) {
                        ...
                        if (json && json.error) {
                            ...
                            if (json && json.results && json.results[0]) {
                                ...
                                if (formres.orderid > '' && formres.orderid != '0') { window.tildaForm.orderIdForStat = formres.orderid }
                            } else {
                                formres.tranid = '0';
                                formres.orderid = '0'
                            }
