...
window.isSearchBot = !1,
    ...
    function(n) {
        ...
        }, e.prototype.getVideoObject = function(e) { for (var t = 0, o = this.videoTags.length; o < t; t++) { var i = this.videoTags[t]; if (i.v === e) return i } return null }, e.prototype.getVideoBoundingRect = function(e, t) { void 0 === t && (t = !0); return (t && n(e).parents(".r")[0] || e).getBoundingClientRect() }, window.videoLoadProcessor = new e
    }(jQuery),
    function(_) {
        function e() {
        ...
        function T(e) {
            ...
            if (300 < (t = o.find("div[data-hook-content]").outerHeight()) && i < t + 40 && (1e3 < (t = t + 120) && (t += 100), console.log("auto correct cover height: " + t), o.find(".t-cover").height(t), o.find(".t-cover__filter").height(t), o.find(".t-cover__carrier").height(t), o.find(".t-cover__wrapper").height(t), 0 == $isMobile && setTimeout(function() {
                ...
                }, 2e3), "function" == typeof window.t_lazyload_updateResize_elem)) try { window.t_lazyload_updateResize_elem(o.find(".t-cover__carrier")) } catch (e) { console.log("error:" + e) }
        }
        ...
        e.prototype.defaultConfig = { orientation: "vertical", speedFactor: 1, automated: !1 }, e.prototype.sequenceObjects = [], e.prototype.recalculateAllSequencesOffsets = function() { this._resizeTimeout && clearTimeout(this._resizeTimeout), this._resizeInterval && clearInterval(this._resizeInterval), this._resizeTimeout = setTimeout(jQuery.proxy(function() { this.scrollCb(), this._resizeInterval = setInterval(jQuery.proxy(this.scrollCb, this), 500) }, this), 10) }, e.prototype.registerNewBlock = function(t) {
            ...
            var i = t.querySelector('[data-hook="sequence-holder"]'),
                ...
                c = (this.itemHeight, { sequenceBlock: t, sequenceHolder: i, sequenceHolderTopOffset: r, sequenceHeight: a, items: n, started: !1, prevBackgroundColor: "" });
            ...
            if (null != a) { 1 < (i = r.top / this.itemTransitionTop) ? i = 1 : i < 0 && (i = 0); for (c = 0, s = n.length; c < s; c++) t = n[c].node, "fixed" != (o = n[c].backgroundHolder.style).position && (o.position = "fixed"), c == a ? (o.opacity = 1 - i, t.querySelector(".txt-holder").style.opacity = 1 - i) : c == a - 1 ? (o.opacity = i, t.querySelector(".txt-holder").style.opacity = i) : (o.opacity = 0, t.querySelector(".txt-holder").style.opacity = 0) }
            ...
            _(document).ready(function() {
                ...
                var p = _("#record-" + x).find("img[data-hook-clogo]");
                if (p.length && p.load(function() { setTimeout(function() { T(x) }, 500) }), $isMobile && _(window).on("orientationchange", function() { T(x) }), ("" !== c || "" !== s || "" !== t) && 0 == $isMobile)
                    if ("" != t || "" == c && "" == s) {
                        if ("" != t) {
                ...
                if ("dynamic" == a && 0 == $isMobile && r.parallax("50%", .2, !0), "yes" == l && "" != e && "" == c && "" == s && "" == t) { _("<img/>").attr("src", e).load(function() { _(this).remove(), r.css("background-image", "url('" + e + "')"), r.css("opacity", "1") }), r.css("background-image", ""), r.css("opacity", "0"), r.css("transition", "opacity 25ms") }
                var b = _("#record-" + x).find(".t-cover__arrow-wrapper");
                0 < b.length && b.click(function() {
                    var e = _("#record-" + x).height();
                    0 < e && _("html, body").animate({ scrollTop: _("#record-" + x).offset().top + e }, 500)
                })
            })
        }, _(document).ready(function() {
    ...
    function(y) {
        y.fn.videoBG = function(e, t) {
            ...
            else if (e.width("auto").height(i), (t = (e.width() - o) / 2) < 0 && (t = 0), e.css("left", -t), 0 === t) setTimeout(function() { y.fn.videoBG.setFullscreen(e) }, 500);
            ...
            return !1
        }, y.fn.videoBG.wrapper = function() { var e = y("<div/>"); return e.addClass("videoBG_wrapper").css("position", "absolute").css("top", 0).css("left", 0), e }, y.fn.videoBG.defaults = { mp4: "", ogv: "", webm: "", poster: "", autoplay: !0, loop: !0, scale: !1, position: "absolute", opacity: 1, textReplacement: !1, zIndex: 0, width: 0, height: 0, fullscreen: !1, imgFallback: !0 }
    }(jQuery),
    function(d) {
        var r = d(window),
            l = r.height();
    ...
    function(g) {
        Tilda.sendEcommerceEvent = function(e, t) {
            ...
            if (d = g("#allrecords").data("tilda-currency") || g(".t706").data("project-currency-code") || "RUB", o = o || window.location.href, 0 < (i = i ? parseFloat(i) : 0))
                if (window.dataLayer || (window.dataLayer = []), -1 != e.indexOf("/tilda/") && -1 != e.indexOf("/payment/") && window.tildaForm && "" < window.tildaForm.orderIdForStat) o = { ecommerce: { purchase: { actionField: { id: window.tildaForm.orderIdForStat }, products: window.tildaForm.arProductsForStat } }, event: "purchase" };
            ...
            if ("" < window.mainMetrika && window[window.mainMetrika] && (r ? 0 < i ? window[window.mainMetrika].hit(e, { title: t, order_price: i, params: o }) : window[window.mainMetrika].hit(e, { title: t }) : 0 < i ? window[window.mainMetrika].reachGoal(e, { title: t, params: o, order_price: i }) : window[window.mainMetrika].reachGoal(e, { title: t, referer: o })), null != window.fbq && 0 == c) try {
                ...
                else 0 < i && d ? window.fbq("track", "InitiateCheckout", { content_name: t, content_category: e, value: i, currency: d }) : window.fbq("track", "Lead", { content_name: t, content_category: e });
            ...
            try { 1 == g("#allrecords").length && "no" == g("#allrecords").data("tilda-cookie") || Tilda.saveUTM() } catch (e) {}
            g(".r").off("click", "a.js-click-stat"), g(".r").on("click", "a.js-click-stat", function(e) {
                ...
                return g.ajax({
                    ...
                    success: function(e) {
                        ...
                        if ("{" == e.substring(0, 1)) { if (window.JSON && window.JSON.parse ? json = window.JSON.parse(e) : json = g.parseJSON(e), !json) return void Tilda.showFormError(i, !1); if ("" < json.error) return void Tilda.showFormError(i, json.error) } else if ("http" == e.substring(0, 4)) {
