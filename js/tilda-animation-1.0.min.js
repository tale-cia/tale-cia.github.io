...
function t_animate__startAnimation() {
    ...
    function n() { t_animate__getGroupsOffsets(t), t_animate__getChainOffsets(a), t_animate__getElemsOffsets(e) }(void 0 !== t && 0 != t.length || void 0 !== e && 0 != e.length || void 0 !== a && 0 != a.length) && (t_animate__setAnimationState(t, a, e), t = t.filter(".r:has(.t-animate_wait)"), e = e.filter(".t-animate_wait"), a = a.filter(".r:has(.t-animate_wait)"), n(), $(window).bind("resize", t_throttle(n, 200)), setInterval(n, 5e3), $(window).bind("scroll", t_throttle(function() { t_animate__animateOnScroll(t, a, e) }, 200)))
}
...
function t_animate__animateNumbers(t) {
    t.each(function() {
        ...
        if (n.find("span:not(.t-animate__number):first").each(function() { a = $(this).attr("style") }), t) {
            ...
            $({ animateCounter: m }).animate({ animateCounter: s }, {
                duration: 1500,
                easing: "swing",
                step: function(t) {
                    var a = Math.pow(10, r),
    ...
    if (0 != r.length) {
        ...
        r.each(function() {
            ...
            if (a < i) {
                ...
                var e = .16 * o + _;
                t.css("transition-delay", e + "s"), t.addClass("t-animate_started"), t.attr("data-animate-start-time", Date.now() + 1e3 * e), t[0] == r.last()[0] && t_animate__checkSectionButtonAnimation(n, e), o++, t.on("TransitionEnd webkitTransitionEnd oTransitionEnd MSTransitionEnd", function(t) { $(this).addClass("t-animate__chain_showed"), $(this).off(t) })
...
function t_animate__checkSectionButtonAnimation__outOfTurn(t) { if (0 === t.find(".t-animate[data-animate-chain=yes]:not(.t-animate_started)").length) { t_animate__checkSectionButtonAnimation(t, .16) } }
