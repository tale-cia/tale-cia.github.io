...
function t_showZoom() {
    $(".t-records").on("click", ".t-zoomable", function(o) {
        ...
        }), 1 < $(".t-carousel__zoomer__item").size() ? $("body").addClass("t-zoomer__show_fixed") : $(".t-carousel__zoomer__control").css("display", "none"), $(".t-carousel__zoomer__inner").click(function(o) { $("body").removeClass("t-zoomer__show"), $("body").removeClass("t-zoomer__show_fixed"), $(document).unbind("keydown") });
        var a = 0;
